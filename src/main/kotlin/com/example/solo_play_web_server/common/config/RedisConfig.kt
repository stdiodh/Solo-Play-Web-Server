...
class RedisConfig {
    @Bean
    fun reactiveRedisTemplate(factory: ReactiveRedisConnectionFactory): ReactiveRedisTemplate<String, PendingMember> {
        ...
        val valueSerializer = Jackson2JsonRedisSerializer(objectMapper, PendingMember::class.java)
        ...
        val serializationContext = RedisSerializationContext
            .newSerializationContext<String, PendingMember>(keySerializer)
