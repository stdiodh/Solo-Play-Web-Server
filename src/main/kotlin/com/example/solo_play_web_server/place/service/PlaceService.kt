...
class PlaceService (
    ...
    companion object {
        private val KAKAO_CATEGORY_EXCLUSION_LIST = setOf(
            "음식점", "문화,예술", "관광,명소", "여행", "숙박", "스포츠,레저", "서비스,산업",
            "상점", "쇼핑", "교통,수송", "금융", "은행", "생활,편의", "부동산", "공공기관",
            "교육,학문", "학교", "학원", "병원", "의료,건강", "동물", "카페", "가정,생활", "여가시설"
        )
    }
    ...
    private fun toPlaceDocument(kakaoPlace: KakaoPlace): Place? {
        ...
        val autoGeneratedTags = kakaoPlace.categoryName
            .split(" > ")
            .filterNot { category -> category in KAKAO_CATEGORY_EXCLUSION_LIST }
            .map { tagText -> "#$tagText"}
